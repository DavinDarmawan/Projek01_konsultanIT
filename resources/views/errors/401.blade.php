...
<head>
    ...
    <title>401 - Akses Ditolak | Icommits</title>
    ...
    <style>
        ...
        * { font-family: 'Poppins', sans-serif; }
        ...
        /* Animasi ikon gembok */
        .lock-body { animation: lockShake 3s ease-in-out infinite; transform-origin: center; }
        @keyframes lockShake {
        ...
        .lock-shackle { animation: shackleMove 3s ease-in-out infinite; transform-origin: bottom center; }
        @keyframes shackleMove {
            0%, 80%, 100% { transform: translateY(0); }
            90% { transform: translateY(-3px); }
        }
        .keyhole { animation: keyholeGlow 2s ease-in-out infinite; }
        ...
        .btn-error:active { transform: translateY(-1px) scale(0.98); }
        ...
        <div class="card-error">
            ...
            <div class="illustration">
                ...
                <svg viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <!-- Shackle (bagian atas gembok) -->
                    <g class="lock-shackle">
                        <path d="M46 68 V50 Q46 26 70 26 Q94 26 94 50 V68" stroke="#006B4C" stroke-width="7" stroke-linecap="round" fill="none"/>
                    </g>
                    <!-- Body gembok -->
                    <g class="lock-body">
                        <rect x="32" y="65" width="76" height="54" rx="10" fill="#e8f5f0" stroke="#006B4C" stroke-width="3"/>
                        <!-- Keyhole -->
                        <g class="keyhole">
                            <circle cx="70" cy="86" r="8" fill="#006B4C"/>
                            <rect x="66" y="90" width="8" height="14" rx="4" fill="#006B4C"/>
                        </g>
                    </g>
                    <!-- Bintang / sparkle kecil -->
                    <text x="100" y="30" font-size="14" fill="#006B4C" opacity="0.3">✦</text>
                    <text x="18" y="60" font-size="10" fill="#006B4C" opacity="0.25">✦</text>
                </svg>
            </div>
            ...
            <p>Kamu tidak memiliki izin untuk mengakses halaman ini.<br>Silakan login terlebih dahulu untuk melanjutkan.</p>

            <a href="{{ route('admin.login') }}" class="btn-error">
