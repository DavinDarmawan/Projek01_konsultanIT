...
<head>
    ...
    <title>501 - Fitur Belum Tersedia | Icommits</title>
    ...
    <style>
        ...
        * { font-family: 'Poppins', sans-serif; }
        ...
        /* Animasi ikon konstruksi / under construction */
        .gear-big {
        ...
        <div class="card-error">
            ...
            <div class="illustration">
                ...
                <svg viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Gear besar -->
                    <g class="gear-big">
                        <circle cx="62" cy="72" r="20" stroke="#006B4C" stroke-width="3" fill="#e8f5f0"/>
                        <circle cx="62" cy="72" r="8" fill="#006B4C" opacity="0.2"/>
                        <!-- Gerigi gear besar -->
                        <rect x="59" y="48" width="6" height="10" rx="2" fill="#006B4C"/>
                        <rect x="59" y="86" width="6" height="10" rx="2" fill="#006B4C"/>
                        <rect x="38" y="69" width="10" height="6" rx="2" fill="#006B4C"/>
                        <rect x="76" y="69" width="10" height="6" rx="2" fill="#006B4C"/>
                        <rect x="44" y="54" width="6" height="10" rx="2" fill="#006B4C" transform="rotate(45 47 59)"/>
                        <rect x="74" y="54" width="6" height="10" rx="2" fill="#006B4C" transform="rotate(-45 77 59)"/>
                        <rect x="44" y="74" width="6" height="10" rx="2" fill="#006B4C" transform="rotate(-45 47 79)"/>
                        <rect x="74" y="74" width="6" height="10" rx="2" fill="#006B4C" transform="rotate(45 77 79)"/>
                    </g>

                    <!-- Gear kecil -->
                    <g class="gear-small">
                        <circle cx="90" cy="52" r="13" stroke="#006B4C" stroke-width="2.5" fill="#e8f5f0"/>
                        <circle cx="90" cy="52" r="5" fill="#006B4C" opacity="0.2"/>
                        <!-- Gerigi gear kecil -->
                        <rect x="87.5" y="36" width="5" height="8" rx="1.5" fill="#006B4C"/>
                        <rect x="87.5" y="60" width="5" height="8" rx="1.5" fill="#006B4C"/>
                        <rect x="74" y="49.5" width="8" height="5" rx="1.5" fill="#006B4C"/>
                        <rect x="98" y="49.5" width="8" height="5" rx="1.5" fill="#006B4C"/>
                    </g>

                    <!-- Kunci inggris / wrench -->
                    <g class="wrench">
                        <path d="M100 40 Q108 32 112 36 Q116 40 108 48 L90 66 L84 60 Z" fill="#006B4C" opacity="0.7"/>
                        <circle cx="107" cy="35" r="5" stroke="#006B4C" stroke-width="2.5" fill="#e8f5f0"/>
                    </g>

                    <!-- Tanda segitiga warning kecil -->
                    <g transform="translate(20, 90)">
                        <polygon points="12,0 24,20 0,20" fill="#fef3c7" stroke="#f59e0b" stroke-width="1.5"/>
                        <text x="9" y="16" font-size="10" font-weight="700" fill="#f59e0b">!</text>
                    </g>
                </svg>
            </div>
            ...
            <p>Fitur yang kamu minta masih dalam tahap pengembangan.<br>Tim kami sedang mengerjakan ini untuk kamu.</p>
