...
@section('page-title', 'Edit Teknologi')
        ...
        <form action="{{ route('admin.technologies.update', $technology->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control border-3 border-black rounded-0" 
                       placeholder="Contoh: Laravel, Vue.js, Bootstrap" 
                ...
                <div class="row g-2">
                    <div class="col-md-8">
                        <input type="text" name="icon" id="icon" class="form-control border-3 border-black rounded-0" 
                               placeholder="Contoh: bi-laptop, bi-code-slash" 
                               value="{{ old('icon', $technology->icon ?? 'bi-code') }}">
                    ...
                    <div class="col-md-4">
                        <div class="border-3 border-black p-3 text-center bg-white" style="height: 100%; display: flex; align-items: center; justify-content: center;">
                            <i class="bi {{ old('icon', $technology->icon ?? 'bi-code') }}" 
                               id="iconPreview" 
                               style="font-size: 2.5rem; color: {{ old('color', $technology->color ?? '#2e7d32') }};"></i>
                        </div>
                    </div>
                </div>
                <div class="mt-2">
                ...
                <div class="row g-2">
                    <div class="col-md-4">
                        <input type="color" name="color" id="colorPicker" class="form-control border-3 border-black rounded-0" 
                               ...
                               value="{{ old('color', $technology->color ?? '#2e7d32') }}">
                    </div>
                    <div class="col-md-8">
                        <input type="text" name="color_text" id="colorText" class="form-control border-3 border-black rounded-0" 
                               placeholder="#2e7d32" value="{{ old('color', $technology->color ?? '#2e7d32') }}">
